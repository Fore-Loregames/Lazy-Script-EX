...
set "VSIX=%~dp0LazyScriptEX-Native-GameKit-0.18.1.vsix"
set "CODE_CLI="
...
echo Installing LazyScriptEX Native GameKit 0.18.1 into Visual Studio Code...
echo Using: %CODE_CLI%
echo.
...
echo.
echo SUCCESS: LazyScriptEX Native GameKit 0.18.1 is installed.
