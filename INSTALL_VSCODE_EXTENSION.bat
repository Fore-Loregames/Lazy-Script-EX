...
set "VSIX=%~dp0LazyScriptEX-Native-GameKit-0.18.17-circular-reference-fix.vsix"
set "CODE_CLI="
...
echo Installing LazyScriptEX Native GameKit 0.18.17 into Visual Studio Code...
echo Using: %CODE_CLI%
echo.
...
echo.
echo SUCCESS: LazyScriptEX Native GameKit 0.18.17 is installed.
