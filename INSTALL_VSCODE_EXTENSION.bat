...
set "VSIX=%~dp0LazyScriptEX-Native-GameKit-0.18.16-autocomplete-replace-fix.vsix"
set "CODE_CLI="
...
echo Installing LazyScriptEX Native GameKit 0.18.16 into Visual Studio Code...
echo Using: %CODE_CLI%
echo.
...
echo.
echo SUCCESS: LazyScriptEX Native GameKit 0.18.16 is installed.
