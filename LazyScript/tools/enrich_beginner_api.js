...
for (const entry of data.entries) {
  ...
  else if (entry.kind === 'compiler feature') info = { friendlyDescription: entry.description, whatItIs: entry.description, whenToUse: MODULE_GUIDES[entry.module]?.whenToUse || '' };
...
data.generated = { ...(data.generated || {}), beginnerMetadata: '0.18.0' };
