...
void main(){float clipCoverage=roundedClipCoverage(pixelPosition,clipRect,clipRadii);if(clipCoverage<=0.001)discard;color=texture(sourceTexture,uv)*tint;color.a*=clipCoverage;if(color.a<=0.001)discard;}
